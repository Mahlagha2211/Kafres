export default function Order() {
  return (
    <div className="flex flex-col justify-center items-center gap-y-16  mx-20 my-20">
      <div className="bg-mainColor w-96 rounded-full text-center font-bold py-2">
        چگونه سفارش ثبت کنیم؟
      </div>
      <div className="bg-maincolor1 space-y-6  w-full rounded-lg py-14 px-20">
        <p className=" text-xl">
          نحوه ی ثبت سفارش به شدددددت راحته. کافیه این 3 مرحله رو انجام بدی:
        </p>
        <ol className=" list-inside list-decimal text-[17px] space-y-2 ">
